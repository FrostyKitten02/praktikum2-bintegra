...
import si.bintegra.portal.client.resource.v1_0.UserResource;
...
public abstract class BaseUserResourceTestCase {
	...
	public void testEscapeRegexInStringFields() throws Exception {
		...
		Assert.assertEquals(regex, user.getName());
	}

	@Test
	public void testGetTestPath() throws Exception {
		User postUser = testGetTestPath_addUser();

		User getUser = userResource.getTestPath();

		assertEquals(postUser, getUser);
		assertValid(getUser);
	}

	protected User testGetTestPath_addUser() throws Exception {
		throw new UnsupportedOperationException(
			"This method needs to be implemented");
	}

	@Test
	public void testGraphQLGetTestPath() throws Exception {
		User user = testGraphQLGetTestPath_addUser();
					...
					JSONUtil.getValueAsString(
						invokeGraphQLQuery(
							new GraphQLField(
								...
								getGraphQLFields())),
						"JSONObject/data", "Object/testPath"))));
	}

	@Test
	public void testGraphQLGetTestPathNotFound() throws Exception {
		Assert.assertTrue(true);
	}

	protected User testGraphQLGetTestPath_addUser() throws Exception {
		return testGraphQLUser_addUser();
	}
	...
	protected List<GraphQLField> getGraphQLFields() throws Exception {
		...
		for (java.lang.reflect.Field field :
				getDeclaredFields(si.bintegra.portal.dto.v1_0.User.class)) {
	...
	@Inject
	private si.bintegra.portal.resource.v1_0.UserResource _userResource;
