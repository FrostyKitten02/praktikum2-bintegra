...
public abstract class BaseServiceDtoResourceImpl implements ServiceDtoResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless/v1.0/service/{id}'  -u 'test@liferay.com:test'
	 */
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless/v1.0/service' -d $'{"id": ___, "price": ___, "title": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.tags.Tags(value = {})
	@javax.ws.rs.Consumes({"application/json", "application/xml", "text/plain"})
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseServiceDtoResourceImpl.class);
