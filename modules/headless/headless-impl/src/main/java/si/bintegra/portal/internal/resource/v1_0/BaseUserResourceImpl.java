...
public abstract class BaseUserResourceImpl implements UserResource {
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless/v1.0/test-path'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(description = "returns user")
	@io.swagger.v3.oas.annotations.tags.Tags(value = {})
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/test-path")
