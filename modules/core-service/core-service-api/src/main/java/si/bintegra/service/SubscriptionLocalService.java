...
public interface SubscriptionLocalService
	...
	public Subscription deleteSubscription(long id) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Subscription fetchSubscription(long id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Subscription getSubscription(long id) throws PortalException;
