...
/**
 * The persistence utility for the offer option service. This utility wraps <code>si.bintegra.service.persistence.impl.OfferOptionPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class OfferOptionUtil {
	 ...
	 */
	public static void clearCache(OfferOption offerOption) {
		getPersistence().clearCache(offerOption);
	}
	 ...
	 */
	public static Map<Serializable, OfferOption> fetchByPrimaryKeys(
	 ...
	 */
	public static List<OfferOption> findWithDynamicQuery(
	 ...
	 */
	public static OfferOption update(OfferOption offerOption) {
		return getPersistence().update(offerOption);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static OfferOption update(
		OfferOption offerOption, ServiceContext serviceContext) {

		return getPersistence().update(offerOption, serviceContext);
	}
	 ...
	 */
	public static List<OfferOption> findByUuid(String uuid) {
	 ...
	 */
	public static List<OfferOption> findByUuid(
	 ...
	 */
	public static OfferOption findByUuid_First(
			String uuid, OrderByComparator<OfferOption> orderByComparator)
		throws si.bintegra.exception.NoSuchOfferOptionException {
	 ...
	 */
	public static OfferOption fetchByUuid_First(
		String uuid, OrderByComparator<OfferOption> orderByComparator) {
	 ...
	 * @throws NoSuchOfferOptionException if a matching offer option could not be found
	 */
	public static OfferOption findByUuid_Last(
			String uuid, OrderByComparator<OfferOption> orderByComparator)
		throws si.bintegra.exception.NoSuchOfferOptionException {
	 ...
	 */
	public static OfferOption fetchByUuid_Last(
		String uuid, OrderByComparator<OfferOption> orderByComparator) {
	 ...
	 */
	public static OfferOption[] findByUuid_PrevAndNext(
			long id, String uuid,
			OrderByComparator<OfferOption> orderByComparator)
		throws si.bintegra.exception.NoSuchOfferOptionException {
	 ...
	 */
	public static void cacheResult(OfferOption offerOption) {
		getPersistence().cacheResult(offerOption);
	}
	 ...
	 */
	public static void cacheResult(List<OfferOption> offerOptions) {
		getPersistence().cacheResult(offerOptions);
	}
	 ...
	 */
	public static OfferOption create(long id) {
	 ...
	 * @throws NoSuchOfferOptionException if a offer option with the primary key could not be found
	 */
	public static OfferOption remove(long id)
		throws si.bintegra.exception.NoSuchOfferOptionException {

		return getPersistence().remove(id);
	}

	public static OfferOption updateImpl(OfferOption offerOption) {
		return getPersistence().updateImpl(offerOption);
	}
	 ...
	 * @throws NoSuchOfferOptionException if a offer option with the primary key could not be found
	 */
	public static OfferOption findByPrimaryKey(long id)
		throws si.bintegra.exception.NoSuchOfferOptionException {
	 ...
	 */
	public static OfferOption fetchByPrimaryKey(long id) {
	 ...
	 */
	public static List<OfferOption> findAll() {
	 ...
	 */
	public static List<OfferOption> findAll(int start, int end) {
	...
	public static OfferOptionPersistence getPersistence() {
		return _persistence;
	}

	private static volatile OfferOptionPersistence _persistence;
