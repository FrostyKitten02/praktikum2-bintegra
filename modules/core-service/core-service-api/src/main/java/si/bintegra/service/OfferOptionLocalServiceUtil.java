...
/**
 * Provides the local service utility for OfferOption. This utility wraps
 * <code>si.bintegra.service.impl.OfferOptionLocalServiceImpl</code> and
 ...
 * @generated
 */
public class OfferOptionLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>si.bintegra.service.impl.OfferOptionLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static OfferOption addOfferOption(OfferOption offerOption) {
		return getService().addOfferOption(offerOption);
	}
	 ...
	 */
	public static OfferOption createOfferOption(long id) {
		return getService().createOfferOption(id);
	}
	 ...
	 */
	public static OfferOption deleteOfferOption(long id)
		throws PortalException {

		return getService().deleteOfferOption(id);
	}
	 ...
	 * @return the offer option that was removed
	 */
	public static OfferOption deleteOfferOption(OfferOption offerOption) {
		return getService().deleteOfferOption(offerOption);
	}
	...
	public static OfferOption fetchOfferOption(long id) {
		return getService().fetchOfferOption(id);
	}
	 ...
	 * @throws PortalException if a offer option with the primary key could not be found
	 */
	public static OfferOption getOfferOption(long id) throws PortalException {
		return getService().getOfferOption(id);
	}
	 ...
	 */
	public static List<OfferOption> getOfferOptions(int start, int end) {
		return getService().getOfferOptions(start, end);
	}
	 ...
	 */
	public static int getOfferOptionsCount() {
		return getService().getOfferOptionsCount();
	}
	 ...
	 */
	public static OfferOption updateOfferOption(OfferOption offerOption) {
		return getService().updateOfferOption(offerOption);
	}

	public static OfferOptionLocalService getService() {
		return _service;
	}

	private static volatile OfferOptionLocalService _service;
