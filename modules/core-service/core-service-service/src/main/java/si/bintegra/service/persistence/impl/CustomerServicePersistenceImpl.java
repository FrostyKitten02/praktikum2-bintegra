 ...
 * @generated
 */
@Component(service = CustomerServicePersistence.class)
public class CustomerServicePersistenceImpl
	extends BasePersistenceImpl<CustomerService>
	implements CustomerServicePersistence {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use <code>CustomerServiceUtil</code> to access the customer service persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	@Override
	public List<CustomerService> findByUuid(String uuid) {
	 ...
	 */
	@Override
	public List<CustomerService> findByUuid(String uuid, int start, int end) {
	 ...
	 */
	@Override
	public List<CustomerService> findByUuid(
	...
	public List<CustomerService> findByUuid(
		...
		if (useFinderCache) {
			list = (List<CustomerService>)finderCache.getResult(
				finderPath, finderArgs, this);

			if ((list != null) && !list.isEmpty()) {
				for (CustomerService customerService : list) {
					if (!uuid.equals(customerService.getUuid())) {
						list = null;
		...
		if (list == null) {
			...
			sb.append(_SQL_SELECT_CUSTOMERSERVICE_WHERE);
			...
			if (orderByComparator != null) {
				...
				sb.append(CustomerServiceModelImpl.ORDER_BY_JPQL);
			}
			...
			try {
				...
				list = (List<CustomerService>)QueryUtil.list(
	...
	public CustomerService findByUuid_First(
		...
		CustomerService customerService = fetchByUuid_First(
		...
		throw new NoSuchCustomerServiceException(sb.toString());
	}
	...
	public CustomerService fetchByUuid_First(
		...
		List<CustomerService> list = findByUuid(uuid, 0, 1, orderByComparator);
	...
	public CustomerService findByUuid_Last(
		...
		CustomerService customerService = fetchByUuid_Last(
			uuid, orderByComparator);
	...
	public CustomerService fetchByUuid_Last(
		...
		List<CustomerService> list = findByUuid(
	...
	public CustomerService[] findByUuid_PrevAndNext(
		...
		CustomerService customerService = findByPrimaryKey(id);
		...
		try {
			...
			array[0] = getByUuid_PrevAndNext(
				session, customerService, uuid, orderByComparator, true);

			array[1] = customerService;

			array[2] = getByUuid_PrevAndNext(
				session, customerService, uuid, orderByComparator, false);
	...
	protected CustomerService getByUuid_PrevAndNext(
		Session session, CustomerService customerService, String uuid,
		OrderByComparator<CustomerService> orderByComparator,
		boolean previous) {
		...
		List<CustomerService> list = query.list();
	...
	public void removeByUuid(String uuid) {
		for (CustomerService customerService :
	...
	public int countByUuid(String uuid) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_CUSTOMERSERVICE_WHERE);
	...
	private static final String _FINDER_COLUMN_UUID_UUID_3 =
		"(customerService.uuid IS NULL OR customerService.uuid = '')";
	...
	public CustomerServicePersistenceImpl() {
		...
		setModelImplClass(CustomerServiceImpl.class);
		setModelPKClass(long.class);

		setTable(CustomerServiceTable.INSTANCE);
	}
	...
	public void clearCache() {
		entityCache.clearCache(CustomerServiceImpl.class);

		finderCache.clearCache(CustomerServiceImpl.class);
	}
	...
	public void clearCache(CustomerService customerService) {
		entityCache.removeResult(CustomerServiceImpl.class, customerService);
	}
	...
	public void clearCache(List<CustomerService> customerServices) {
		for (CustomerService customerService : customerServices) {
			entityCache.removeResult(
				CustomerServiceImpl.class, customerService);
		}
	}
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(CustomerServiceImpl.class, primaryKey);
		}
	}
	...
	public CustomerService create(long id) {
		...
		customerService.setPrimaryKey(id);

		String uuid = _portalUUID.generate();

		customerService.setUuid(uuid);
	...
	public CustomerService remove(Serializable primaryKey)
		...
		try {
			...
			CustomerService customerService = (CustomerService)session.get(
			...
			if (customerService == null) {
				...
				throw new NoSuchCustomerServiceException(
					_NO_SUCH_ENTITY_WITH_PRIMARY_KEY + primaryKey);
			}

			return remove(customerService);
		}
		catch (NoSuchCustomerServiceException noSuchEntityException) {
	...
	protected CustomerService removeImpl(CustomerService customerService) {
		...
		try {
			...
			if (!session.contains(customerService)) {
				customerService = (CustomerService)session.get(
					CustomerServiceImpl.class,
	...
	public CustomerService updateImpl(CustomerService customerService) {
		...
		if (!(customerService instanceof CustomerServiceModelImpl)) {
			InvocationHandler invocationHandler = null;

			if (ProxyUtil.isProxyClass(customerService.getClass())) {
				invocationHandler = ProxyUtil.getInvocationHandler(
					customerService);

				throw new IllegalArgumentException(
					"Implement ModelWrapper in customerService proxy " +
						invocationHandler.getClass());
			}

			throw new IllegalArgumentException(
				"Implement ModelWrapper in custom CustomerService implementation " +
					customerService.getClass());
		}

		CustomerServiceModelImpl customerServiceModelImpl =
			(CustomerServiceModelImpl)customerService;

		if (Validator.isNull(customerService.getUuid())) {
			String uuid = _portalUUID.generate();
		...
		try {
			...
			if (isNew) {
				...
				customerService = (CustomerService)session.merge(
					customerService);
			}
		}
		catch (Exception exception) {
		...
		entityCache.putResult(
			CustomerServiceImpl.class, customerServiceModelImpl, false, true);
	...
	/**
	 * Returns the customer service with the primary key or throws a <code>com.liferay.portal.kernel.exception.NoSuchModelException</code> if it could not be found.
	 *
	 * @param primaryKey the primary key of the customer service
	...
	public List<CustomerService> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sb.append(_SQL_SELECT_CUSTOMERSERVICE);
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query query = session.createQuery(_SQL_COUNT_CUSTOMERSERVICE);
	...
	protected String getSelectSQL() {
		return _SQL_SELECT_CUSTOMERSERVICE;
	}

	@Override
	protected Map<String, Integer> getTableColumnsMap() {
		return CustomerServiceModelImpl.TABLE_COLUMNS_MAP;
	}
	...
	public void activate() {
		...
		_setCustomerServiceUtilPersistence(this);
	}

	@Deactivate
	public void deactivate() {
		_setCustomerServiceUtilPersistence(null);

		entityCache.removeCache(CustomerServiceImpl.class.getName());
	}

	private void _setCustomerServiceUtilPersistence(
		...
		try {
			...
			field.set(null, customerServicePersistence);
		}
	...
	private static final String _SQL_SELECT_CUSTOMERSERVICE =
		"SELECT customerService FROM CustomerService customerService";

	private static final String _SQL_SELECT_CUSTOMERSERVICE_WHERE =
		"SELECT customerService FROM CustomerService customerService WHERE ";

	private static final String _SQL_COUNT_CUSTOMERSERVICE =
		"SELECT COUNT(customerService) FROM CustomerService customerService";

	private static final String _SQL_COUNT_CUSTOMERSERVICE_WHERE =
		"SELECT COUNT(customerService) FROM CustomerService customerService WHERE ";

	private static final String _ORDER_BY_ENTITY_ALIAS = "customerService.";

	private static final String _NO_SUCH_ENTITY_WITH_PRIMARY_KEY =
		"No CustomerService exists with the primary key ";

	private static final String _NO_SUCH_ENTITY_WITH_KEY =
		"No CustomerService exists with the key {";

	private static final Log _log = LogFactoryUtil.getLog(
		CustomerServicePersistenceImpl.class);
