...
import si.bintegra.service.SubscriptionLocalService;
import si.bintegra.service.SubscriptionLocalServiceUtil;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link si.bintegra.service.impl.SubscriptionLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see si.bintegra.service.impl.SubscriptionLocalServiceImpl
 * @generated
 */
public abstract class SubscriptionLocalServiceBaseImpl
	...
	public Subscription createSubscription(long id) {
		return subscriptionPersistence.create(id);
	}
	...
	public Subscription deleteSubscription(long id) throws PortalException {
		return subscriptionPersistence.remove(id);
	}
	...
	public Subscription fetchSubscription(long id) {
		return subscriptionPersistence.fetchByPrimaryKey(id);
	}
	...
	public Subscription getSubscription(long id) throws PortalException {
		return subscriptionPersistence.findByPrimaryKey(id);
	}
