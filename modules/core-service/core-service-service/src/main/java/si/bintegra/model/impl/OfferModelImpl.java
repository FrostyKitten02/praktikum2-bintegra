...
import si.bintegra.model.OfferModel;

/**
 * The base model implementation for the Offer service. Represents a row in the &quot;FOO_Offer&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class OfferModelImpl extends BaseModelImpl<Offer> implements OfferModel {
	 ...
	 */
	public static final String TABLE_NAME = "FOO_Offer";
	...
	public static final String TABLE_SQL_CREATE =
		"create table FOO_Offer (uuid_ VARCHAR(75) null,id_ LONG not null primary key,type_ VARCHAR(75) null,title VARCHAR(75) null,active_ BOOLEAN)";

	public static final String TABLE_SQL_DROP = "drop table FOO_Offer";

	public static final String ORDER_BY_JPQL = " ORDER BY offer.title ASC";

	public static final String ORDER_BY_SQL = " ORDER BY FOO_Offer.title ASC";
	...
	static {
		...
		attributeGetterFunctions.put("id", Offer::getId);
		attributeSetterBiConsumers.put(
			"id", (BiConsumer<Offer, Long>)Offer::setId);
		attributeGetterFunctions.put("type", Offer::getType);
		attributeSetterBiConsumers.put(
			"type", (BiConsumer<Offer, String>)Offer::setType);
	...
	public ExpandoBridge getExpandoBridge() {
		return ExpandoBridgeFactoryUtil.getExpandoBridge(
			0, Offer.class.getName(), getPrimaryKey());
	}
	...
	public Object clone() {
		...
		offerImpl.setId(getId());
		offerImpl.setType(getType());
	...
	public Offer cloneWithOriginalValues() {
		...
		offerImpl.setId(this.<Long>getColumnOriginalValue("id_"));
		offerImpl.setType(this.<String>getColumnOriginalValue("type_"));
	...
	public CacheModel<Offer> toCacheModel() {
		...
		offerCacheModel.id = getId();

		offerCacheModel.type = getType();

		String type = offerCacheModel.type;

		if ((type != null) && (type.length() == 0)) {
			offerCacheModel.type = null;
		}
